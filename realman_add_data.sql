...
# Add shop owner
INSERT INTO account(first_name,last_name,staff_code,phone,password,role_code, role_name,thumbnail, account_status_code, account_status_name) 
	VALUE('SHOP', 'OWNER', 'RM123', '0981874777','$2a$12$Z.UfJHlsxFnF8hnLGKwpveo8mSOIlk9Rb5Z9jyVWHx9hTe/gILH1G','SHOPOWNER', 'Chủ sở hữu','-','ACTIVATED', 'Đang công tác');
